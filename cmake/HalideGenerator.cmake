...
#modified from https://github.com/fish2000/libimread/blob/master/cmake/HalideGenerator.cmake
...
function(halide_generator_output_path args_GENERATOR_NAME result_var)
    ...
    set(gen_dir "${NATIVE_INT_DIR}genfiles/${args_GENERATOR_NAME}")
    file(MAKE_DIRECTORY "${scratch_dir}")

    # Set the output variable
    # set(${result_var} "${scratch_dir}" PARENT_SCOPE)
    set(${result_var} "${gen_dir}" PARENT_SCOPE)
